...
exports.insert = function insert(collectionName, obj, callback) {
  ...
  if (controlDB != null) {
    console.log('insert ' + obj + ' to ' + collectionName);
    controlDB.collection(collectionName, function(err, collection) {
      if (err == null) {
...
exports.queryFindAll = function queryFindAll(collectionName, obj, callback) {
  if (controlDB != null) {
    console.log('query ' + obj + ' from ' + collectionName);
    controlDB.collection(collectionName, function(err, collection) {
      if (err == null) {
...
exports.update = function update(collectionName, obj, updateData, callback) {
  if (controlDB != null) {
    console.log('update ' + obj + ' do ' + updateData + ' from ' + collectionName);
    controlDB.collection(collectionName, function(err, collection) {
      if (err == null) {
...
exports.remove = function remove(collectionName, obj, callback) {
  if (controlDB != null) {
    console.log('remove ' + obj + ' from ' + collectionName);
    controlDB.collection(collectionName, function(err, collection) {
      if (err == null) {
